...
{
    public partial class ApbdEfContext : DbContext
    {
        public ApbdEfContext()
        {
        }

        public ApbdEfContext(DbContextOptions<ApbdEfContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            //{
            //    optionsBuilder.UseSqlServer("Server=MICHO\\SQLEXPRESS;Database=ApbdEf;Trusted_Connection=True");
            //}
        }
